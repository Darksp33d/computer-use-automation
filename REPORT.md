...
Groove, verified on 2026-09-11. Two genuine model discoveries produced reviewed, reusable capabilities. The suite passes 23 unit and 62 browser tests; 100 fresh local replays passed without retries. Caller-supplied goals, unsupported-goal rejection and safe failure diagnostics are evidenced. [Runs, recording and measurement limits](evidence/README.md).
